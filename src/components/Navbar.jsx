...
import { caseylogo, menu, close } from '../assets'
    ...
    return (
        ...
        <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
            ...
            <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
                ...
                >
                    <img src={caseylogo} alt="logo" className='w-9 h-9 object-contain' />
                    <p className='text-white text-[18px] font-bold cursor-pointer'>Casey Edens | Frontend Dev</p>
                </Link>
